...
class SimNode(AirbotPlayTaskBase):
    ...
    def check_success(self):
        ...
        diff = abs(self.mj_data.qpos[self.drawer_index]-self.origin_drawer_pos)
        return diff > 0.1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--drawers", type=int, default=5, help="select drawers(from 1 to 6)")
        ...
        try:
            if stm.trigger(): 
                ...
                if stm.state_idx == 0: # 伸到柜子前
                    tmat_handle = get_site_tmat(sim_node.mj_data, drawers)
